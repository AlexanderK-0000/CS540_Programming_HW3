...
HW3.cpp is a c++ file that is *based on what the profesor uploaded to blackboard
...
Also, I used the offset size of 256 for each file. That's represented with 8 bits and therefore corresponds cleanly to 2 hex digits
The 1024 offset size the cpp file from the profesor orginally used was represented with 10 bits (2.5 hex digits) which was just incredibly confusing to look at
